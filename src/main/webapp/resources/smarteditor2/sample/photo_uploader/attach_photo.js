	...
	function onAjaxError (){
		alert("[가이드]사진 업로더할 서버URL셋팅이 필요합니다.-onAjaxError"+e.response.responeText);
	}
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '${pageContext.request.contextPath}/resources/smarteditor2/file_uploader.jsp',
 	        sCallback : '${pageContext.request.contextPath}/resources/smarteditor2/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
